...
//CONFIGURE BASE URL STATIS //REVISI IN MACBOOK
// $config['base_url'] = 'http://localhost/rka-web-w/'; //development
//$config['base_url'] = 'http://10.0.1.90/rka-web/'; //production local
// $config['base_url'] = 'http://aplikasi2.gratika.id/rka-web/'; //production publiz biznet

// CONFIGURE BASE URL DINAMIS
$config['base_url'] = ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == "on") ? "https" : "http");
$HOST = (
    ((isset($_SERVER['HTTP_X_FORWARDED_HOST']) && $_SERVER['HTTP_X_FORWARDED_HOST'] == "aplikasi2.gratika.id") ? "://aplikasi2.gratika.id/rka-web/" :
    ((isset($_SERVER['HTTP_X_FORWARDED_HOST']) && $_SERVER['HTTP_X_FORWARDED_HOST'] == "gratika.co.id") ? "://gratika.co.id/rka-web/" :
...
define('LIVE', $live); //simpan (define)
/*
|--------------------------------------------------------------------------
| Index File
|--------------------------------------------------------------------------
...
// $config['sess_save_path'] = 't_sessions';//its your table name name
// $config['sess_match_ip'] = FALSE;
// $config['sess_time_to_update'] = 300;
...
/*
    CONFIG PRIVATE "ITEM"
*/
$config['session-key'] = 'missyou';
$config['secret-key'] = '1q2w3e4r5t';
$config['core-authorization'] = 'aGFuaWZhbGJhYWl0czIwMTkjZG5zI3Byb2Rldl9HcjR0MWs0I1NBRw==';

$config['lumen-authorization'] = 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJsdW1lbi1qd3QiLCJzdWIiOjEyMiwiaWF0IjoxNTg2NDE0ODU3LCJleHAiOjQ3NDIwODg0NTcsInBkdSI6bnVsbH0.Hdemn_gXH8wVrKzYV0QvW0Ij_Xc094Iu3KdcTTeK1ms';
$config['rka-authorization'] = 'q2Pu8Jcabbw+VGMjo29b9y3TDcd3cJ4jd5/3FCgJtjYrFk7TwyNSp57v5CfjBN5Tazo+9okBJ5YkNkbvHucYOQ==';

if (LIVE == "production") {   
    $config['url-lumen']='http://10.0.1.90:8003';   
