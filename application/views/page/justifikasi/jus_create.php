...
<div class="page">
    <div class="page-header">
        <h1 class="page-title">Create Justification</h1>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="home">Home</a></li>
            <li class="breadcrumb-item active">Justification</li>
            <li class="breadcrumb-item active">Create Justification</li>
        </ol>
    </div>
    ...
    <div class="page-content">
        ...
        <div class="panel panel-primary panel-line">
            ...
            <div class="panel-body">
                <?php $dttgl = array('data-toggle' => 'validator'); echo form_open_multipart('justification/save'); ?>
                <div class="modal-body">
                    ...
                    <div id="wizard-content" class="wizard-content">
                        <div style="display:show" class="wizard-pane" id="wizard-project" role="tabpanel">
                            ...
                            <?php 
                                if ($rab == null) {
                                    ...
                                    $id_rab = $rab->id_rab;
                                    $id_diminta = $rab->diminta_oleh;
                                    $no_rab = $rab->nomor_pengajuan;
                                    $irb = base64_encode($rab->id_rab);
                                }
                            ?>
                            <div class="row">
                                <input type="text" class="form-control validate_char" id="id_rab" name="id_rab"
                                    placeHolder="type your location" hidden value="<?php echo $id_rab; ?>" />
                                ...
                                <div id="div_project" class="col-lg-6 form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <?php if ($rab != null) { ?>
                                        <input id="add_id_project" name="add_id_project" type="text"
                                            class="form-control" value="<?php echo $rab->id_project; ?>" readOnly
                                            hidden />
                                        <input type="text" class="form-control"
                                            value="<?php echo $rab->project->nama_project; ?>" readOnly />
                                        <?php } else { ?>
                                        <select id="add_id_project" name="add_id_project" class="form-control"
                                            data-plugin="selectpicker" data-live-search="true"
                                            onchange="select_id_project(event)" required>
                                            <option selected disabled></option>
                                            <option value="0">No Project</option>
                                            <?php foreach ($projects as $project){
                                                    $project = $project->project;
                                                    if ($project->id_project == $ipr) {
                                                        echo "<option selected value=".$project->id_project.">".$project->nama_project."</option>";
                                                    } else {
                                ...
                                <div class="col-lg-6 form-group row">
                                    <label class="col-lg-3 col-form-label">No RAB: </label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control validate_char" id="add_nomor_rab"
                                            value="<?php echo $no_rab; ?>" readOnly />
                                        <small><a href="<?php echo site_url("rab/document_rab?irb=".$irb); ?>"
                                                target="_blank">
                                                <?php echo $no_rab; ?></a></small>
                                    </div>
                                </div>
                                <?php }?>
                                ...
                                <div class="col-lg-6 form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <?php if ($rab != null) { ?>
                                        <input id="add_id_pic" name="add_id_pic" type="text" class="form-control"
                                            value="<?php echo $id_diminta; ?>" readOnly hidden />
                                        <input type="text" class="form-control"
                                            value="<?php echo $rab->diminta_pegawai->full_name; ?>" readOnly />
                                        <?php } else { ?>
                                        <select id="add_id_pic" name="add_id_pic" class="form-control"
                                            ...
                                            <?php foreach ($pegawais as $pegawai){
                                                    if ($pegawai->level <= 4 ) {
                                                        if ($pegawai->iduser == $id_diminta) {
                                                            echo "<option selected value=".$pegawai->iduser.">".$pegawai->full_name."</option>";
                                                        } else {
                                                            echo "<option value=".$pegawai->iduser.">".$pegawai->full_name."</option>";
                                                        }
                                                    }
                                                } ?>
                                        </select>
                                        <small><a href="<?php echo site_url("rab/history"); ?>">link to
                                                rab</a></small>
                                        <?php } ?>
                                ...
                                <?php if ($rab != null) { ?>
                                <div class="col-lg-6 form-group row">
                                    <label class="col-lg-3 col-form-label">RAB dibuat tanggal: </label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control validate_char"
                                            value="<?php echo $rab->dibuat_tgl; ?>" readOnly />
                                    </div>
                                </div>
                                <?php }?>

                                <div class="col-lg-6 form-group row">
                                    <label class="col-lg-3 col-form-label">Latar Belakang: </label>
                                    <div class="col-lg-9">
                                        <textarea class="form-control validate_char" id="add_latar_belakang"
                                            name="add_latar_belakang" placeholder="masukan latar belakang"
                                            required></textarea>
                                    </div>
                                </div>
                                <div class="col-lg-6 form-group row">
                                    <label class="col-lg-3 col-form-label">Aspek Strategis: </label>
                                    <div class="col-lg-9">
                                        <textarea class="form-control validate_char" id="add_aspek_strategis"
                                            name="add_aspek_strategis" placeholder="masukan aspek strategis"
                                            required></textarea>
                                    </div>
                                </div>
                                <div class="col-lg-6 form-group row">
                                    <label class="col-lg-3 col-form-label">Aspek Bisnis: </label>
                                    <div class="col-lg-9">
                                        <textarea class="form-control validate_char" id="add_aspek_bisnis"
                                            name="add_aspek_bisnis" placeholder="masukan aspek bisnis"
                                            required></textarea>
                                    </div>
                                </div>
                                <div class="col-lg-6 form-group row">
                                    <label class="col-lg-3 col-form-label">Spesifikasi Teknis: </label>
                                    <div class="col-lg-9">
                                        <textarea class="form-control validate_char" id="add_spesifikasi"
                                            name="add_spesifikasi" placeholder="masukan spesifikasi teknis"
                                            required></textarea>
                                    </div>
                                </div>
                                <div class="col-lg-6 form-group row">
                                    <label class="col-lg-3 col-form-label">Aspek Lain: </label>
                                    <div class="col-lg-9">
                                        <textarea class="form-control validate_char" id="add_aspek_lain"
                                            name="add_aspek_lain" placeholder="masukan aspek lain" required></textarea>
                                    </div>
                                </div>
                                <div class="col-lg-6 form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <textarea class="form-control validate_char" id="add_catatan" name="add_catatan"
                                            placeholder="catatan pendukung" required></textarea>
                                    </div>
                                </div>
                                <div class=" col-lg-6 form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="radio-custom radio-default radio-inline">
                                            <input class="form-control" type="radio" id="justifikasi_status_internal"
                                                name="justifikasi_status" value="0" checked />
                                            <label>Internal</label>
                                        </div>
                                        <div class="radio-custom radio-default radio-inline">
                                            <input class="form-control" type="radio" id="justifikasi_status_external"
                                                name="justifikasi_status" value="1" />
                                            <label>External</label>
                                        </div>
                                    </div>
                                </div>
                                <div class=" col-lg-6 form-group row">
                                    <label class="col-lg-3 col-form-label">Kas Kecil</label>
                                    <div class="col-lg-9">
                                        <div class="radio-custom radio-default radio-inline">
                                            <input class="form-control" type="radio" id="justifikasi_kas_no"
                                                name="justifikasi_kas" value="0" checked />
                                            <label>Tidak</label>
                                        </div>
                                        <div class="radio-custom radio-default radio-inline">
                                            <input class="form-control" type="radio" id="justifikasi_kas_yes"
                                                name="justifikasi_kas" value="1" />
                                            <label>Ya</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6 form-group row">
                                    <label class="col-lg-3 control-label"><b>File Pendukung:</b></label>
                                    <div class="col-lg-9">
                                        <input type="file" id="input-file-now" name='add_file[]' data-plugin="dropify"
                                            data-default-file="" multiple="true" required>
                                        <small>Tolong masukan file pendukung justifikasi , seperti : Invoice / PO / SPK
                                            / Struk / Bon / dll. <b>Format file wajib pdf.</b></small>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div style="display:none" class="wizard-pane" id="wizard-item" role="tabpanel">
                            ...
                            <table id="add_table_item" class="table table-responsive" style="width:100%">
                                ...
                                <tbody id="add_tb_body_item">
                                    ...
                                    <?php endforeach; ?>
                                    <?php } else{ ?>
                                    <tr id="add_tb_tr_item0">
                                        <td>1
                                            <input hidden type="text" class="form-control" name="add_item_id[]"
                                                value="0" required />
                                        </td>
                                        <td>
                                            <textarea class="form-control" name="add_kegiatan[]" id="add_kegiatan0"
                                                placeholder="type your activity" required></textarea>
                                        </td>
                                        <td>
                                            <input type="number" min='1' class="form-control" name="add_jumlah[]"
                                                id="add_jumlah0" required placeholder="type your count item" />
                                        </td>
                                        <td>
                                            <input type="number" min='1' class="form-control" name="add_harga[]"
                                                id="add_harga0" required placeholder="type your price item" />

                                        <td>
                                            <textarea class="form-control" name="add_keterangan[]" id="add_keterangan0"
                        ...
                        <div style="display:none" class="wizard-pane" id="wizard-coa" role="tabpanel">
                            ...
                            <table id="add_table_coa" class="table table-responsive" style="width:100%">
                                ...
                                <tbody id="add_tb_body_coa">
                                    ...
                                    <?php endforeach; ?>
                                    <?php } else { ?>
                                    <tr id="add_tb_tr_coa0">
                                        <td>1
                                            <input hidden type="text" class="form-control" name="add_coa_id[]" value="0"
                                                required />
                                        </td>
                                        <td>
                                            <select id="add_coa_nmr0" name="add_coa_nmr[]" class="form-control"
                                                data-plugin="select2" data-live-search="true"
                                                onchange="changeSaldo_tabel('0')" required>
                                                <?php 
                                                    $flag_pendapatan = 0;
                                                    $bln_today = (int) date('m'); 
                                                    $dumy_coa = "";
                                        ...
                                        <td>
                                            <select id="add_coa_bln0" name="add_coa_bln[]" class="form-control"
                                                data-plugin="select2" data-live-search="true"
                                                onchange="changeSaldo_tabel('0')" required>
                                                <option value="<?php echo $bln_today; ?>">
                                                    <?php echo "Month ".$bln_today; ?>
                                                </option>
                                            </select>
                                        </td>
                                        <td>
                                            ...
                                            <input disabled type="text" class="form-control" name="add_coa_harga[]"
                                                id="add_coa_harga0"
                                                value="<?php echo "Rp. " . number_format( $coas[$flag_pendapatan + ($bln_today-1)]->saldo_coa, 0, ',', '.') . " ,-";?>" />
                                            <?php } else { ?>
                                            <input disabled type="text" class="form-control" name="add_coa_harga[]"
                                                id="add_coa_harga0" />
                                            <?php }  ?>
                                        ...
                                        <td>
                                            <input type="number" min='0' class="form-control" name="add_saldo[]"
                                                id="add_saldo0" value="0" required
                                                placeholder="type your value needed" />
                                        </td>
                                        <td>
                                            <!-- <span class="badge badge-success"><i class="icon wb-check"
                                        ...
                                        <td>
                                            <button id="add_coaDinamis" type="button"
                                                class="btn btn-pure btn-default icon wb-plus p-0"></button>
                                            <button type="button" onClick="return remove_coaDinamis(0)"
                                                class="btn btn-pure btn-default icon wb-trash p-0"></button>
                                        </td>
                                    </tr>
                                    <?php } ?>
                        ...
                        <div style="display:none" class="wizard-pane" id="wizard-confirm" role="tabpanel">
                            <div class="row">
                                ...
                                <div class="col-lg-3" style="margin:auto">
                                    <h4 id="auto-generated-id" class="text-right"></h4>
                                </div>
                                <div class="col-lg-6"><br />
                                    ...
                                    <div class="column" style="float: left;width: 80%;">
                                        ...
                                        <p id="c_subdiv">:</p>
                                        <p id="c_nomor">: <?php 
                                        if ($rab != null) { echo $rab->nomor_pengajuan;
                                        } else { echo "Auto Generated"; }?></p>
                                    </div>
                                </div>
                                <div class="col-lg-6"><br />
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="column" style="float: left;width: 87%;">
                                        <p id="c_latar_belakang"></p>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="column" style="float: left;width: 13%;">
                    ...
                    <div id="alert-add-jus" style="display:none" class="alert dark alert-danger alert-dismissible"
                        role="alert">
                    ...
                    <div class="wizard-buttons">
                        ...
                        <button style="display:none" id="btn_add_submit" type="submit"
                            ...
                            class="btn btn-success btn-outline float-right">Create Justification</button>
                    </div>
...
function tambah_rra() {
    ...
    let count = JSON.parse(localStorage.getItem('form-dinamis-coa-jus'));
    let id = 0;
    let idx = id + 1;
    if (count.length != 0) {
    ...
    count.push(id);
    localStorage.setItem('form-dinamis-coa-jus', JSON.stringify(count));
...
function custom_create_confirm(con) {
    let value = parseInt(localStorage.getItem('create-wizard-jus')); //kalo udah sampe angka 2 (paling terakhir);
    if (value == 3) {
...
function remove_itemDinamis(id) {
    ...
    if (confirm) {
        ...
        $(form).remove();
        let count = JSON.parse(localStorage.getItem('form-dinamis-item-jus'));
        let newCt = [];
        ...
        localStorage.setItem('form-dinamis-item-jus', JSON.stringify(newCt));
    };
}
...
function remove_coaDinamis(id) {
    ...
    if (confirm) {
        ...
        localStorage.setItem('form-dinamis-coa-jus', JSON.stringify(newCt));
    };
}
...
function set_confirm_lb() {
    ...
    let latar_belakang = document.getElementById("add_latar_belakang").value;
    let aspek_strategis = document.getElementById("add_aspek_strategis").value;
    let aspek_bisnis = document.getElementById("add_aspek_bisnis").value;
    let spesifikasi = document.getElementById("add_spesifikasi").value;
    let aspek_lain = document.getElementById("add_aspek_lain").value;
    let catatan = document.getElementById("add_catatan").value;

    let interex = $("input[name='justifikasi_status']:checked").val();
    let kas_kecil = $("input[name='justifikasi_kas']:checked").val();
    if (interex == "0") {
        interex = "Internal";
    } else {
        interex = "External";
    ...
    $("#c_latar_belakang").text(latar_belakang);
    $("#c_aspek_strategis").text(aspek_strategis);
    $("#c_aspek_bisnis").text(aspek_bisnis);
    $("#c_spesifikasi").text(spesifikasi);
    $("#c_aspek_lain").text(aspek_lain);
    $("#c_catatan").text(catatan);

    $("#c_status").text(': ' + interex);
    $("#c_kas_kecil").text(': ' + kas_kecil);

    let date_generated = "<?php echo date("Ymd");?>"
    let auto_generated = "#JST";
    if (ipr.length == 1) {
        auto_generated += "00" + ipr + date_generated + "XXX";
    } else if (ipr.length == 2) {
        auto_generated += "0" + ipr + date_generated + "XXX";
    } else {
        auto_generated += ipr + date_generated + "XXX";
    }
    document.getElementById("auto-generated-id").innerHTML = auto_generated;

    let countItem = JSON.parse(localStorage.getItem('form-dinamis-item-jus'));
    let total_item = 0;
    ...
    let countCoa = JSON.parse(localStorage.getItem('form-dinamis-coa-jus'));
    let total_Coa = 0;
...
function next() {
    let value = parseInt(localStorage.getItem('create-wizard-jus'));
    ...
    if (value == 0) {
        ...
        let latar_blkg = document.getElementById("add_latar_belakang").value;
        let aspek_strategis = document.getElementById("add_aspek_strategis").value;
        let aspek_bisnis = document.getElementById("add_aspek_bisnis").value;
        let spesifikasi = document.getElementById("add_spesifikasi").value;
        let aspek_lain = document.getElementById("add_aspek_lain").value;
        let catatan = document.getElementById("add_catatan").value;
        let file = document.getElementById("input-file-now").value;
        // let file = "dumy"
        console.log("file: " + file);
        // console.log("id_project: " + id_project);
        // console.log("id_pic: " + id_pic);

        if (id_project == "" || id_pic == "" || latar_blkg == "" || aspek_strategis == "" ||
            aspek_bisnis == "" || spesifikasi == "" || catatan == "" || file == "") {
            ...
            localStorage.setItem('create-wizard-jus', value + 1);
            $("#alert-add-jus").hide();
...
function otomatis_isi_value(id_total, id_harga) {
    ...
    let count_c = JSON.parse(localStorage.getItem('form-dinamis-coa-jus'));
    let jumlah_coa = 0;
...
function back() {
    ...
    if (value > 0) {
        ...
        localStorage.setItem('create-wizard-jus', value);
...
$(document).ready(function() {
    ...
    localStorage.setItem('create-wizard-jus', 0);
    ...
    localStorage.setItem('form-dinamis-item-jus', JSON.stringify(arr_item));
    localStorage.setItem('form-dinamis-coa-jus', JSON.stringify(arr_payment));
    ...
    $(add_buttonItem).click(function() {
        ...
        count.push(id);
        localStorage.setItem('form-dinamis-item-jus', JSON.stringify(count));
    });
