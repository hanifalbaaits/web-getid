...
<div class="page">
    <div class="page-header">
        <h1 class="page-title">Create RAB</h1>
        <ol class="breadcrumb">
        ...
        <div class="panel panel-primary panel-line">
            ...
            <div class="panel-body">
                <!-- <form data-parsley-validate class="form-horizontal form-label-left" method="post"
                    ...
                    action="<?php echo site_url(). "/rab/save" ?>"> -->
                    ...
                    <div id="wizard-content" class="wizard-content">
                        <div style="display:show" class="wizard-pane" id="wizard-project" role="tabpanel">
                            <div class="row">
                                ...
                                <div class="col-lg-6 form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control validate_char" id="add_sasaran"
                                            name="add_sasaran" placeHolder="type your location" required />
                                    </div>
                                </div>
                                <div class="col-lg-6 form-group row">
                                ...
                                <div class="col-lg-6 form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control validate_char" id="add_fasilitas"
                                            name="add_fasilitas" placeHolder="type your location" required />
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <!-- <input name='add_file' id='add_file' type="file" multiple="true"> -->
                        ...
                        <div style="display:none" class="wizard-pane" id="wizard-coa" role="tabpanel">
                            <h5 class="text-center">COA yang digunakan
                                ...
                                <!-- <button type="button" id="add_coaDinamis" class="btn btn-danger btn-xs">
                                    <i class="icon wb-plus"></i> Add COA </button> -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6"><br />
                                    ...
                                    <div class="column" style="float: left;width: 80%;">
                                        <p id="c_project">: Logbook Apps</p>
                                        <p id="c_divisi">: Technical Supoort</p>
                                        <p id="c_subdiv">: Development | Bisnis Support</p>
                                    </div>
                                </div>
                                <div class="col-lg-6"><br />
                                    ...
                                    <div class="column" style="float: left;width: 70%;">
                                        ...
                                        <p id="c_pic">: Rizcky Ardiansyah</p>
                                        <p id="c_pic_div">: Technical Support - Development Staff</p>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <hr />
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="column" style="float: left;width: 25%;">
                            ...
                            <p id="vr-no"><b>#<?php echo "01-RRA".date("Ym"); ?></b></p>
                        </div>
                    </div>
                </div>
                <hr />
...
function pengajuan_rra() {
    ...
    let dtPro = JSON.parse(project);
    $("#vr-project").text(': ' + dtPro[0].project.nama_project);
    $('#btn_rra').hide();
}
...
$(document).ready(function() {
    ...
    let last_act = parseInt("0");
    var first = [];
    first.push(last_act);
    localStorage.setItem('form-dinamis-item', JSON.stringify(first));
    localStorage.setItem('form-dinamis-coa', JSON.stringify(first));
