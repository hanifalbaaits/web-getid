                                    ...
                                    <div class="nk-block-head-content">
                                        ...
                                        <div class="nk-block-des">
                                            <p class="lead">We are on a mission to make the web a better place. The
                                                following terms, as well as our Policy and Terms of Service, apply to
                                                all users.</p>
                                        ...
                                        <div class="card-inner card-inner-xl">
                                            <div class="entry">
                                                ...
                                                <p>We’ve decided to make these Terms available under a <strong>Creative
                                                        Commons</strong> license. You can grab a copy of these Terms and
                                                    other legal documents on Github. You’re more than welcome to copy
                                                    them, adapt them, and repurpose them for your own use.</p>
                                                <h4>Introduction</h4>
                                                ...
                                                <ul class="list list-sm list-checked">
                                                    ...
                                                    <li>Certain areas of this Website are restricted from being access
                                                        ...
                                                        confidential and you must maintain confidentiality as well.</li>
                                                </ul>
                                                <h4>Your Content</h4>
                                                ...
                                                <h4>No warranties</h4>
                                                <p>This Website is provided “as is,” with all faults, and Company Name
                                                ...
                                                <p>In no event shall Company Name, nor any of its officers, directors
                                                ...
                                                <h4>Assignment</h4>
                                                <p>The Company Name is allowed to assign, transfer, and subcontract its
                                                ...
                                                <p>These Terms constitute the entire agreement between Company Name and
