                                ...
                                <form class="nk-wizard nk-wizard-simple is-alter" method="post"
                                    ...
                                    <div class="nk-wizard-content">
                                        <div class="row gy-3">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="form-label" for="pulsa">Pilih Paket Data</label>
                                                    <div class="form-control-wrap ">
                                                        <div class="form-control-select">
                                                            <select class="form-control required" data-msg="Required"
                                                                id="pulsa" name="pulsa" required
                                                                data-placeholder="Pilih Paket Data">
                                                    ...
                                                    <div class="form-note">Pilih Paket Data yang di inginkan</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
