                ...
                <div class="components-preview">
                    <div class="nk-block-head nk-block-head-lg wide-sm">
                        <div class="nk-block-head-content">
                            ...
                            <h2 class="nk-block-title fw-normal">Beli Paket Data</h2>
                        </div>
                    </div>
                            ...
                            <div class="card-inner">
                                <form class="form-validate is-alter" method="post"
                                    ...
                                    <div class="row g-gs">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="form-label" for="pulsa">Pilih Kouta Data</label>
                                                <div class="form-control-wrap ">
                                                    <select class="form-control form-select" id="pulsa" name="pulsa"
                                                        data-placeholder="Pilih Data" required>
                                                        <option label="empty" value=""></option>
                                                        <option value="X5">XL DATA 5000 mb</option>
                                                        <option value="X10">XL DATA 10000 mb</option>
                                                        <option value="X20">XL DATA 20000 mb</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group float-right">
                                                <button type="submit" class="btn btn-lg btn-primary"
                                                    onclick="act_confirm()">Beli Paket Data</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
